...
function scoreCampaign(project) {
  ...
  const productFocus = Math.max(54, Math.min(100, productScene?.elements.some((el) => el.layerName === "Uploaded Asset" || el.layerName === "Product Focus") ? 92 : 70));
  ...
  const metrics = [
    ...
    metric("Product Focus", productFocus, productFocus >= 84 ? "The product or offer is easy to identify." : "Product focus needs stronger visual anchoring.", "Increase Product Focus")
  ];
